...
func lineBetweenNodeA(nodeA: SCNVector3, nodeB: SCNVector3) -> SCNNode {
	...
	line.firstMaterial?.emission.contents = UIColor.whiteColor()
...
func redLine(nodeA: SCNVector3, nodeB: SCNVector3) -> SCNNode {
	...
	let line = SCNGeometry(sources: [source], elements: [element])
	line.firstMaterial?.lightingModelName = SCNLightingModelConstant
	line.firstMaterial?.emission.contents = UIColor.redColor()
	return SCNNode(geometry: line)
}