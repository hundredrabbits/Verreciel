...
class RecipesLibrary
{
	...
	init()
	{
		...
		// Currencies
		horadric.append( Recipe(name: "alta", ingredients: [items.materia, items.materia, items.materia, items.materia], result: Item(name: "atla", type: .currency, note:"a trading currency")) )
		horadric.append( Recipe(name: "ingot", ingredients: [items.alta, items.alta, items.alta, items.alta], result: Item(name: "ingot", type: .currency, note:"a trading currency")) )
	}
}