...
class StructureHoradric : Structure
{
	...
	override init()
	{
		...
		let cube1 = ShapeCube(size: radius, color:grey)
		...
		let cube2 = ShapeCube(size: radius, color:grey)
		...
		let cube3 = ShapeCube(size: radius, color:grey)
		...
		let cube4 = ShapeCube(size: radius, color:grey)
		...
		let cube5 = ShapeCube(size: radius, color:grey)
		...
		let cube6 = ShapeCube(size: radius, color:grey)
