...
class PanelWindow : SCNNode
{
	...
	func addInterface()
	{
		...
		self.addChildNode(SCNLine(nodeA: SCNVector3(x: 0, y: ceilingNode[0].y + 2, z: ceilingNode[0].z),nodeB: SCNVector3(x: ceilingNode[2].x, y: ceilingNode[0].y + 2, z: 0),color:white))
		self.addChildNode(SCNLine(nodeA: SCNVector3(x: 0, y: ceilingNode[0].y + 2, z: ceilingNode[0].z),nodeB: SCNVector3(x: ceilingNode[6].x, y: ceilingNode[4].y + 2, z: 0),color:white))
		self.addChildNode(SCNLine(nodeA: SCNVector3(x: 0, y: ceilingNode[0].y + 2, z: -ceilingNode[0].z),nodeB: SCNVector3(x: ceilingNode[2].x, y: ceilingNode[0].y + 2, z: 0),color:white))
		self.addChildNode(SCNLine(nodeA: SCNVector3(x: 0, y: ceilingNode[0].y + 2, z: -ceilingNode[0].z),nodeB: SCNVector3(x: ceilingNode[6].x, y: ceilingNode[4].y + 2, z: 0),color:white))
