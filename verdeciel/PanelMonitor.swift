...
class PanelMonitor : SCNNode
{
	...
	func addInterface()
	{
		...
		labelShieldTitle.name = "monitor.label"
		...
		labelElectricityTitle.name = "monitor.label"
		...
		labelShieldValue.name = "monitor.label"
		...
		labelElectricityValue.name = "monitor.label"
