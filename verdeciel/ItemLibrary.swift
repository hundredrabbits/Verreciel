...
class ItemLibrary
{
	...
	let loiqeKey = Event(newName: "loiqe key", size: 1, type: eventTypes.item, details: itemTypes.card, note:"complete radio", isQuest:true)
	let loiqeKeyFragment1 = Event(newName: "key fragment", size: 1, type: eventTypes.item, details: itemTypes.part, note:"half a key", isQuest:true)
	let loiqeKeyFragment2 = Event(newName: "key fragment", size: 1, type: eventTypes.item, details: itemTypes.part, note:"half a key", isQuest:true)
